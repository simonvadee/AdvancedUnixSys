/*
** syscalls.h for strace in /home/vadee_s/rendu/AUSP_strace
** 
** Made by simon vadée
** Login   <vadee_s@epitech.net>
** 
** Started on  Sun May 17 19:08:49 2015 simon vadée
** Last update Sun May 17 19:08:51 2015 simon vadée
*/

#include "strace.h"

t_sysinfo		g_syscalls[NB_SYSCALL] =
  {
    { "read", "ssize_t", { "int",
			    "void*",
			    "size_t",
    ...
    { "fgetxattr", NULL, { NULL}},
    { "listxattr", NULL, { NULL}},
    { "llistxattr", NULL, { NULL}},
    { "flistxattr", NULL, { NULL}},
    { "removexattr", NULL, { NULL}},
    { "lremovexattr", NULL, { NULL}},
    { "fremovexattr", NULL, { NULL}},
    { "tkill", "int", { "int",
			"int",
			NULL }},
    { "time", "time_t", { "time_t*",
    ...
    { "pwritev", "ssize_t", { "int",
			      ...
			      "off_t",
			      NULL }},
    { "rt_tgsigqueueinfo", "int", { "pid_t",
				    "pid_t",
				    "int",
				    "siginfo_t*"}},

    { "perf_event_open", "int", { "struct pef_event_attr*",
				  "pid_t*",
				  "int",
				  "int",
				  "unsigned long",
